...
btnHold.addEventListener("click", function() {
    ...
    if (dealerHand < 17) {
        ...
        if (draw == 2 && dealerTotalScore < playerTotalScore) {
            ////  DISPLAY 2nd DRAW  /////////
            ...
            ///  DRAW AGAIN IF NOT BUST and DEALER < PLAYER  ////
            if (draw == 3 && dealerTotalScore < playerTotalScore) {
                ///  DISPLAY 3rd DRAW  //////////////
                ...
                dealerTotalScore = dealerHandScore + draw1Score + draw2Score + draw3Score;
                displayDealerScore.textContent = `${dealerTotalScore}`;
                ...
                // if (draw == 4 && dealerTotalScore < playerTotalScore)
            } // end of "IF Draw = 3"
        } // end of "IF Draw = 2"
